...
def compare_models(pos_error, input_state, shots):
    ...
    # set up circuit
    qc_nv = codes.BitFlip_NVCenter(pos_error=pos_error_nv,initialize=input_state).measure_at_end()
...
input_state = snippets.Input_Statevector(30,1).input_state_list_complex()
print(input_state)
...
np.savetxt('bitflip_depolerror_average_18-5-22.dat', aresults)  
